...
metrics.register("liquidation_watchdog_scanned_total",     "counter",   "Positions scanned by the 30s SL/TP watchdog sweep");
metrics.register("liquidation_watchdog_closed_total",      "counter",   "Positions the watchdog closed that the tick-level monitor missed");
metrics.register("liquidation_watchdog_skipped_stale_total", "counter", "Watchdog positions skipped for a stale/missing quote");
metrics.register("liquidation_watchdog_skipped_halted_total", "counter", "Watchdog positions skipped because their symbol is halted");
